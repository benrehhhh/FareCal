...
> authorized charges. The initial fare data in the database is **SAMPLE/test
...
Open `.env` and set your MySQL credentials (especially `DB_PASSWORD`).
...
Open <http://127.0.0.1:5000> in your browser. The homepage shows a
Flask ↔ MySQL connectivity check.
